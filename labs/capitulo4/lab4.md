...
- **Paso 29.** Verifica que el contenedor corra correctamente. Escribe el siguiente comando.
...
- **Paso 39.** En la terminal de **GitBash**, ejecuta con **bind mounts** la montura de los directorios.
